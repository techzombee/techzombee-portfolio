...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Heechan Cho</title>
        <meta name="description" content="Understand how Heechan Cho collects, uses, and protects your personal information." />
      </Head>
      <div className="p-6 max-w-3xl mx-auto">
        ...
        <p className="mb-4">
          Heechan Cho respects your privacy and is committed to protecting your personal data. This policy explains how we collect, use, and protect your data.
        </p>
